...
This file creates maps using the leaflet function and add data in representative circles.
...
Create a map of for the average of each temperature values over certain periods of time (monthly, weekly, daily)
