...
save_plot_as_svg <- function(plot, filename) {
  ggsave(plot, filename = filename, device = "svg", width = 10, height = 6)
}
...
# Save the monthly graphs as SVG files
for (i in seq_along(monthly_graphs)) {
  filename <- paste0("../figures/monthly_graph_", i, ".svg")
  save_plot_as_svg(monthly_graphs[[i]], filename)
}
...
```{r}
save_plot_as_svg(total_plot, "../figures/total_pollutant_levels.svg")
```
