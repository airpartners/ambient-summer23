...
modPM <- subset(modPM, select = -c(url.x, url.y, sn.y, timestamp.y, geo.lat, geo.lon, met.rh, met.temp, met.wd, met.ws, geolat, geolon, metrh, mettemp))
