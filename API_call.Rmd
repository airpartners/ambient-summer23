...
## DATA GUIDE
You can find a premade dataset created using this API call document in 
[this branch](https://github.com/airpartners/ambient-summer23/tree/datafolder)
of the [ambient repository](https://github.com/airpartners/ambient-summer23)
...
-   You can find sensor information, API key and API url here.
