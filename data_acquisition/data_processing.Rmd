...
created and saved into the data folder. This file contains the data
frame `mod_met` that can be used to graph, to visualize this data frame,
simply load it and run the print function commented below:
...
To skip this session, go to the data folder branch of [this
...
-   Select the date range: `7/1/2022 to 2/28/2022` (this dataset is not
